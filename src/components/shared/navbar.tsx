...
export default function NavBar() {
  ...
  return (
    <nav className="sticky top-0 z-20 w-full py-4 md:py-3 bg-white/50 dark:bg-black/50 backdrop-blur-md px-5 sm:px-10 md:px-10 lg:px-32 shadow-sm">
      <div className="flex justify-between xl:grid xl:grid-cols-3 gap-2 items-center max-w-[1500px] mx-auto">
        <Link
          href={"/"}
          className="flex-1 flex group text-2xl font-bold w-full"
        >
